...
<c:set var="fundsStatement" value="select * from [fundmgmtnt:fund] as funds where ISDESCENDANTNODE(contents,'${folderPath}') ${queryConstraint} order by funds.[fundName] asc"/>
<utility:logger level="INFO" value="fundsStatement : ${fundsStatement}"/>
<utility:logger level="INFO" value="maxItems : ${maxItems}"/>

<query:definition var="listQuery" statement="${fundsStatement}" limit="${maxItems}"  />
